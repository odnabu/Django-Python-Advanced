...
--- 
## <span style="color: #003000"> 6. Тестирование работы приложения</span>
...
<a id="img1" style="margin: 40px;">Fig. 1.</a>
...
<a id="img1" style="margin: 40px;">Fig. 2.</a>  
...
```
pip freeze > hw_02_task_manager/requirements_hw_1.txt
```
