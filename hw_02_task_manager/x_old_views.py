...
# _____ hw_06:  1.2.2. Представление для создания задачи
...
# _____ hw_06:  2. Эндпоинты для  -->  2.1. Список всех задач (GET /hw_02_task_manager/tasks/)
...
# _____ hw_06:  2. Эндпоинты для  -->  2.2. Получение задачи по ID (`GET /hw_02_task_manager/tasks/<int:pk>/`)
...
# _____ hw_06:  5. ДОПОЛНИТЕЛЬНО  -->  5.2.2. Подключение Swagger и ReDoc  -->  Примечания
...
# _____ hw_07:  5.1. Представление для создания и получения списка подзадач:
...
# _____ hw_07:  5.2. Класс представлений для получения, обновления и удаления подзадач:
