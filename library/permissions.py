# Link on GitHub: https://github.com/viacheslav-bandylo/111124-projects/blob/main/library/permissions.py
...
class IsOwnerOrReadOnly(BasePermission):
    """
    A custom permission that allows only the owner to edit the object.
